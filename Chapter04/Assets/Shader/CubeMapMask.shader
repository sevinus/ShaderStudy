Shader "denoil/CubeMapMask"
{
	Properties
	{
		_MainTex ("Main Tex", 2D) = "white" {}
		_CubeMapTex ("CubeMap Tex", CUBE) = "" {}
		_CubeMapMaskTex ("CubeMap Mask Tex", 2D) = "white" {}
	...
	SubShader
	{
		...
		void surf(Input IN, inout SurfaceOutput o)
		{
			...
			float4 maskColor = tex2D(_CubeMapMaskTex, IN.uv_MainTex);
			float3 cubeColor = texCUBE(_CubeMapTex, IN.worldRefl).rgb * _ReflAmount * maskColor.r;
